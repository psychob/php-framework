<?php
    ...
    class ValueIsNotGreaterOrEqualException extends ComparisionAssertException
    {
        /**
        ...
        {
            parent::__construct($left, $right, 'not greater or equal to', false, 'is-greater-to', $message, $previous);
        }
    }
